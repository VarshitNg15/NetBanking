...
--
-- Run this script after 01_create_transaction_schema.sql and
...
CREATE TABLE TRANSACTIONS (
    ...
    INITIATED_BY           NUMBER(19) NOT NULL,
...
CREATE TABLE IDEMPOTENCY_RECORDS (
    IDEMPOTENCY_ID    NUMBER(19) PRIMARY KEY,
